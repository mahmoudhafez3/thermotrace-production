...
echo "=========================================="
echo "Deploying Blade Inspection Chaincode"
echo "=========================================="
...
peer lifecycle chaincode queryinstalled > installed_blade.txt
cat installed_blade.txt

# Extract package ID
PACKAGE_ID=$(sed -n "/${CC_NAME}_${CC_VERSION}/{s/^Package ID: //; s/, Label:.*$//; p;}" installed_blade.txt)
echo ""
...
echo ""
echo "=========================================="
echo "✓ Blade Inspection Chaincode Deployed!"
echo "=========================================="
